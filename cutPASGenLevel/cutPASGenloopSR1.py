...
print(cut9,float(cut9)/float(evnumber)*100*genFilterEff[300][270],float(cut9)/float(nEvents)*genFilterEff[300][270]*stop13TeV_NLONLL[300]*12.9*10**3,float(cut9)/float(cut8))
print(cut10,float(cut10)/float(evnumber)*100*genFilterEff[300][270],float(cut10)/float(nEvents)*genFilterEff[300][270]*stop13TeV_NLONLL[300]*12.9*10**3,float(cut10)/float(cut9))
