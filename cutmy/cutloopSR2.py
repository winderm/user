...
#CT1 > 200
	...
	for x in xrange(t.nGenJet):
		...
		if t.GenJet_bMatched[x] == 1 and t.GenJet_pt[x] >= 60 and abs(t.GenJet_eta[x]) < 2.4:
			vetob1 += 1
		if t.GenJet_bMatched[x] == 1 and t.GenJet_pt[x] > 30 and t.GenJet_pt[x] < 60 and abs(t.GenJet_eta[x]) < 2.4:
			vetob2 += 1
