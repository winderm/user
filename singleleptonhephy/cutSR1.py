...
#Preselection
#CT1 + ISR > 100
Ct1 = "(met_genPt>200&&(Sum$(GenJet_pt*(GenJet_pt>30&&abs(GenJet_eta)<2.4))-100)>200&&Sum$((GenJet_pt>100&&abs(GenJet_eta)<2.4))>0)"
##If two hard jets: 
...
#put together
cuts = [susy,Ct1,dphi,vetohard,vetotau,lep,lep20,ctSR1,etaSR1,lepSR1,chargeSR1]
...
for x in xrange(len(cuts)):
	...
	print(x,ev,ev/evnumber1*genFilterEff[300][270],(ev/evnumber1)*genFilterEff[300][270]*stop13TeV_NLONLL[300]*12.9*10**3)
